...
class Rester():
    ...
    def resetarm_auto(self, data):
        self.swift.reset(x=data.x, y=data.y, z=data.z)
    
    def resetarm_pro(self, data):
        self.swift.reset(x=data.x, y=data.y, z=data.z, timeout=0)
...
if __name__ == "__main__":
    ...
    try:
        ...
        sub_auto = rospy.Subscriber('/armreset_auto', position, rester.resetarm_auto, queue_size=1)
        rospy.spin()
